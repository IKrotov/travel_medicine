                        ...
                        <div class="col-9">
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="v-pills-after-trip" role="tabpanel" aria-labelledby="v-pills-after-trip-tab">
                                    ...
                                    <div>
                                        <form name="after-trip-form" method="post" action="admin/country/afterTrip" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <select class="custom-select" name="countryId" required title="Выбор страны">
                                                    <#list allCountry as country>
                                                        <option value="${country.id}">${country.countryName}</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="afterTripText" class="form-control" id="afterTripText" rows="8"></textarea>
                                            </div>
                                            <button type="submit" class="btn btn-primary"> Добавить </button>
                                        </form>
                                    </div>
